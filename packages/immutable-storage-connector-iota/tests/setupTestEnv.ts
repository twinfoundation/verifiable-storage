...
export const TEST_IMMUTABLE_STORAGE_ADDRESS_BECH32 = addresses[0];
...
export async function setupTestEnv(): Promise<void> {
	console.debug(
		"Immutable Storage Address",
		`${process.env.TEST_EXPLORER_URL}addr/${TEST_IMMUTABLE_STORAGE_ADDRESS_BECH32}`
	);
	await TEST_WALLET_CONNECTOR.ensureBalance(
		TEST_IDENTITY_ID,
		TEST_IMMUTABLE_STORAGE_ADDRESS_BECH32,
		1000000000n
	);
}
